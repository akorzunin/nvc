...
map("n", "<F9>", "<cmd> lua require'dap'.toggle_breakpoint() <CR>", d("Toggle breakpoint"))
...
-- work
map("n", "<leader>ee", "<cmd> e ++enc=cp1251 <CR>", d("change encoding to Windows-1251"))
...
map("n", "<leader>gbb", "<cmd> 0,3G blame <CR>", d("view full git blame commit message"))
...
-- buffers
map("n", "<leader>bca", "<cmd> %bd|e# <CR>", d("Close All buffers except current"))
...
map("n", "<leader>fk", "<cmd> Telescope keymaps <CR>", d("View keymaps via Telescope"))
map("n", "<leader>fc", "<cmd> Telescope commands <CR>", d("View neovim commands via Telescope"))
map("n", "<leader>fj", "<cmd> Telescope jumplist <CR>", d("Go to pevious cursor locations"))
map("n", "<leader>fr", "<cmd> Telescope registers <CR>", d("View paste register"))
map("n", "<leader>fff", "<cmd> Telescope builtin previewer=false <CR>", d("View telescope builtins"))
...
-- M["presence.nvim",
map("n", "<leader>dd", "<cmd> Lazy load presence.nvim <CR>", d("enable discord presence"))

-- "nvim-tree",
map("n", "<leader>tt", "<cmd> NvimTreeToggle <CR>", d("toggle nvim-tree"))

-- M.lsp = {
map("n", "<leader>jd", "<cmd> lua vim.lsp.buf.definition() <CR>", d("jump to definition"))
map("n", "<leader>jD", "<cmd> lua vim.lsp.buf.declaration() <CR>", d("jump to declaration"))
map("n", "<leader>jr", "<cmd> lua vim.lsp.buf.references() <CR>", d("jump to references"))
map("n", "<leader>ji", "<cmd> lua vim.lsp.buf.implementation() <CR>", d("jump to implementation"))

--  Telescope commands for LSP
map("n", "<leader>jff", "<cmd> :Telescope builtin default_text=lsp previewer=false <CR>", d("lsp biltins"))
map("n", "<leader>jfd", "<cmd> :Telescope lsp_definition <CR>", d("telescope definition"))
map("n", "<leader>jfD", "<cmd> :Telescope lsp_declaration <CR>", d("telescope declaration"))
map("n", "<leader>jfr", "<cmd> :Telescope lsp_references <CR>", d("telescope references"))
map("n", "<leader>jfi", "<cmd> :Telescope lsp_implementation <CR>", d("telescope implementation"))
